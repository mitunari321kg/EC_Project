                    ...
                    <form class="h-adr" method="POST" action="../controller/Change_Shipping_Address.php">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="prefectures">
                                        ...
                                        <option value="神奈川県" <?php if ($value['prefectures'] == '神奈川県') { ?> selected <?php } ?>>神奈川県 <option value="新潟県" <?php if ($value['prefectures'] == '新潟県') { ?> selected <?php } ?>>新潟県</option>
                                        ...
                                        <option value="和歌山県" <?php if ($value['prefectures'] == '和歌山県') { ?> selected <?php } ?>>和歌山県 <option value="鳥取県" <?php if ($value['prefectures'] == '鳥取県') { ?> selected <?php } ?>>鳥取県</option>
                                        ...
                                        <option value="鹿児島県" <?php if ($value['prefectures'] == '鹿児島県') { ?> selected <?php } ?>>鹿児島県 <option value="沖縄県" <?php if ($value['prefectures'] == '沖縄県') { ?> selected <?php } ?>>沖縄県</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="tel" name="tel" pattern="^0\d{9,10}$" placeholder="ハイフンなしの、半角で入力してください" value="<?php echo $value['tel']; ?>" required size="11" pattern="\d{2,4}-?\d{2,4}-?\d{3,4}">
                                </td>
                            </tr>
                            <tr>
                                <td>
