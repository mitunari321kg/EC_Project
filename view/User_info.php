                            ...
                            <?php foreach ($user_info as $value) { ?>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="postal_code" pattern="\d{3}-?\d{4}" placeholder="例:0001111" onKeyUp="AjaxZip3.zip2addr('postal_code','','prefectures','address1');" size="7" value="<?php echo $value['postal_code']; ?>" maxlength="7" required>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
