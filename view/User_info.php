                            ...
                            <table>
                                <?php foreach ($user_info as $value) { ?>
                                    <tr>
                                        <td>
                                            姓
                                            <input type="text" name="surname" size="24" required value="<?php echo $value['last_name']; ?>">
                                        </td>
                                        <td>
                                            名
                                            <input type="text" name="name" size="24" required value="<?php echo $value['first_name']; ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            姓フリガナ
                                            <input type="text" name="surname_furigana" size="24" required value="<?php echo $value['last_furigana']; ?>">
                                        </td>
                                        <td>
                                            名フリガナ
                                            <input type="text" name="name_furigana" size="24" required value="<?php echo $value['first_furigana']; ?>">
                                        </td>
                                    </tr>
                            </table>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        $birthday = date('Y年 n月 d日', strtotime($value['birthday']));
                                        echo $ubirthday;
                                        ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="tel" name="tel" placeholder="例:0000112222" required size="24" value="<?php echo $value['tel']; ?>" pattern="\d{2,4}-?\d{2,4}-?\d{3,4}" maxlength="11">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="email" id="email" name="mail" placeholder="例:sample_a.1@email.co.jp" required size="56" value="<?php echo $value['email']; ?>" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$">
                                    </td>
                                </tr>
                            <?php } ?>
                            <tr>
